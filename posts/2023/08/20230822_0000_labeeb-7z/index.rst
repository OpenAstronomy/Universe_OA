...
.. tags: gnuastro
.. author: Labib Asari
.. link: https://labeeb-7z.github.io/Blogs/2023/08/22/Final-Report.html
.. description:
.. category: gsoc2023
...
.. raw:: html
    ...
    <p>I will be discussing the goals of my GSoC project, how I spent my time and what I learned during this period. I will also be discussing the future of my project and what I plan to do next.</p>
    
    <h1 id="goals-of-my-gsoc">Goals of my GSoC</h1>
    <!-- TEASER_END -->
    ...
    <h2 id="work-done-throughout-the-gsoc">Work Done Throughout the GSoC</h2>
    ...
    <h3 id="pygnuastro">pyGnuastro</h3>
    ...
    <h3 id="gpus-in-gnuastro">GPUs in Gnuastro</h3>
    ...
    <p>I would also like to thank the Google Summer of Code team for taking the wonderful initiative and giving me this opportunity to work on this project.</p>
